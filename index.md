...
function triggerX()
{
	...
	<h1>PS3Xploit Tools v3.0.5 - PS3 HAN ACT/RIF Copier</h1>
	...
	<hr></div>
	<p><span style="color:#ffffff">USB Root Path </span><select id="comboactPath" name="actPath" size="1" onChange="selectfilePath()">
